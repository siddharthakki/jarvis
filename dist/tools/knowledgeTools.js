...
exports.indexFileTool = exports.searchKnowledgeBaseTool = exports.rememberFactTool = void 0;
...
exports.rememberFactTool = {
    ...
    async execute(args, context) {
        ...
        try {
            await VectorService_1.vectorService.addText(fact, {
...
exports.searchKnowledgeBaseTool = {
    ...
    async execute(args, context) {
        ...
        try {
            const results = await VectorService_1.vectorService.search(query, limit);
            if (results.length === 0) {
                return {
                    success: true,
...
exports.indexFileTool = {
    ...
    async execute(args, context) {
        ...
        try {
            await VectorService_1.vectorService.indexFile(filePath);
            return {
                success: true,
...
// Register the tools
ToolRegistry_1.ToolRegistry.register(exports.rememberFactTool);
ToolRegistry_1.ToolRegistry.register(exports.searchKnowledgeBaseTool);
ToolRegistry_1.ToolRegistry.register(exports.indexFileTool);
